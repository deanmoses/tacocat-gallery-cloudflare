...
Don't defend excessive comments with "it's got the same doc-to-code ratio as the rest of the project". Don't use that as an excuse to avoid the hard work of writing tight just-enough-and-no-more comments.
