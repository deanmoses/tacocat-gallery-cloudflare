...
- **The primary itself goes cold.** Read from a Worker in San Jose, next to D1's primary, an album read after a few idle minutes took 186 and 140 ms of D1 wall time (`x-d1` rtt) and 24 to 34 ms on the reads a second apart, at 1 to 3 ms of SQL each. A cold read from Paris pays this on top of its round trips.
