/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 6880277ad6e52788bc213c7cf475ae51)
...
interface __BaseEnv_Env {
	...
	DEBUGBEAR_API_KEY: string;
	TRANSCODER: DurableObjectNamespace<import("./src/index").Transcoder>;
	UPLOAD_PIPELINE: Workflow<Parameters<import("./src/index").UploadPipeline['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Transcoder";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_ORIGIN" | "DERIVED_ORIGIN" | "MEDIA_BUCKET" | "DERIVED_BUCKET" | "PROBE_TARGET" | "UPLOADS" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "GLOBALPING_TOKEN" | "SESSION_SECRET" | "DEBUGBEAR_API_KEY">> {}
}
