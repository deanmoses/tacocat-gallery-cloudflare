...
describe(parseImageRequest, () => {
    ...
    it.each([
        ...
        { name: 'a width past the detail size', url: '/i/2001/06-15/felix.jpg/v1?size=1025' },
        { name: 'a height past the detail size', url: '/i/2001/06-15/felix.jpg/v1?size=x1025' },
        { name: 'a cover past the detail size', url: '/i/2001/06-15/felix.jpg/v1?size=200x1025' },
